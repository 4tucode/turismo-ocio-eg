<template>
  <div class="gastronomia">
    ...
    <section class="articles-section" aria-label="Artículos de Gastronomía">
      ...
      <div v-else-if="articles.length === 0" class="empty-state">
        ...
        <h2>Próximamente</h2>
        <p>Estamos preparando artículos sobre gastronomía. ¡Vuelve pronto!</p>
      </div>
...
import heroImage from '../assets/comidaguineana.jpg'
...
onMounted(() => {
  unsubscribe = subscribeArticlesByCategory('gastronomia', (data) => {
    articles.value = data
    loading.value = false
  })
})
