<template>
  <div class="naturaleza">
    <div class="hero-section" :style="heroBg">
      <h1 class="hero-title">Naturaleza y Aventura</h1>
      <p class="hero-subtitle">Explora la biodiversidad única y los paisajes impresionantes de Guinea Ecuatorial</p>
    </div>

    <section class="articles-section" aria-label="Artículos de Naturaleza y Aventura">
      ...
      <div v-else-if="articles.length === 0" class="empty-state">
        ...
        <h2>Próximamente</h2>
        <p>Estamos preparando artículos sobre naturaleza y aventura. ¡Vuelve pronto!</p>
      </div>
...
import heroImage from '../assets/naturaleza.jpg'
...
onMounted(() => {
  unsubscribe = subscribeArticlesByCategory('naturaleza', (data) => {
    articles.value = data
    loading.value = false
  })
})
...
.article-location { color: #4facfe; font-size: 0.875rem; font-weight: 500; }
.read-more { color: #4facfe; font-size: 0.875rem; font-weight: 600; }
